...
// RemoveSnapshot provides a mock function with given fields: ctx, snapshotName, opts
func (_m *Client) RemoveSnapshot(ctx context.Context, snapshotName string, opts ...client.OpOption) (*rpcpb.RemoveSnapshotResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, ...client.OpOption) (*rpcpb.RemoveSnapshotResponse, error)); ok {
		return rf(ctx, snapshotName, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, ...client.OpOption) *rpcpb.RemoveSnapshotResponse); ok {
...
// SaveSnapshot provides a mock function with given fields: ctx, snapshotName, force, opts
func (_m *Client) SaveSnapshot(ctx context.Context, snapshotName string, force bool, opts ...client.OpOption) (*rpcpb.SaveSnapshotResponse, error) {
	...
	var _ca []interface{}
	_ca = append(_ca, ctx, snapshotName, force)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, bool, ...client.OpOption) (*rpcpb.SaveSnapshotResponse, error)); ok {
		return rf(ctx, snapshotName, force, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, bool, ...client.OpOption) *rpcpb.SaveSnapshotResponse); ok {
		r0 = rf(ctx, snapshotName, force, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, bool, ...client.OpOption) error); ok {
		r1 = rf(ctx, snapshotName, force, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *Client) UpdateStatus(ctx context.Context) (*rpcpb.UpdateStatusResponse, error) {
	ret := _m.Called(ctx)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (*rpcpb.UpdateStatusResponse, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) *rpcpb.UpdateStatusResponse); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
