...
type StartRequest struct {
	...
	NetworkId     *uint32           `protobuf:"varint,14,opt,name=network_id,json=networkId,proto3,oneof" json:"network_id,omitempty"`
}
...
var file_rpcpb_rpc_proto_rawDesc = []byte{
	...
	0xa8, 0x09, 0x0a, 0x0c, 0x53, 0x74, 0x61, 0x72, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x22, 0x0a, 0x0a, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x5f, 0x69, 0x64, 0x18, 0x0e, 0x20,
	0x01, 0x28, 0x0d, 0x48, 0x06, 0x52, 0x09, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x49, 0x64,
	...
	0x6e, 0x61, 0x6d, 0x69, 0x63, 0x5f, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x42, 0x0d, 0x0a, 0x0b, 0x5f,
	0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x5f, 0x69, 0x64, 0x22, 0x13, 0x0a, 0x11, 0x52, 0x50,
	...
	0x01, 0x2a, 0x22, 0x08, 0x2f, 0x76, 0x31, 0x2f, 0x70, 0x69, 0x6e, 0x67, 0x32, 0xaa, 0x19, 0x0a,
	...
	0x74, 0x6f, 0x72, 0x12, 0x90, 0x01, 0x0a, 0x15, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x53, 0x75,
...
var file_rpcpb_rpc_proto_msgTypes = make([]protoimpl.MessageInfo, 91)
var file_rpcpb_rpc_proto_goTypes = []interface{}{
	...
	(*BlockchainSpec)(nil),                     // 25: rpcpb.BlockchainSpec
	(*CreateBlockchainsRequest)(nil),           // 26: rpcpb.CreateBlockchainsRequest
	(*CreateBlockchainsResponse)(nil),          // 27: rpcpb.CreateBlockchainsResponse
	(*CreateSubnetsRequest)(nil),               // 28: rpcpb.CreateSubnetsRequest
	(*CreateSubnetsResponse)(nil),              // 29: rpcpb.CreateSubnetsResponse
	(*HealthRequest)(nil),                      // 30: rpcpb.HealthRequest
	(*HealthResponse)(nil),                     // 31: rpcpb.HealthResponse
	(*URIsRequest)(nil),                        // 32: rpcpb.URIsRequest
	(*URIsResponse)(nil),                       // 33: rpcpb.URIsResponse
	(*WaitForHealthyRequest)(nil),              // 34: rpcpb.WaitForHealthyRequest
	(*WaitForHealthyResponse)(nil),             // 35: rpcpb.WaitForHealthyResponse
	(*StatusRequest)(nil),                      // 36: rpcpb.StatusRequest
	(*StatusResponse)(nil),                     // 37: rpcpb.StatusResponse
	...
	(*ListSubnetsRequest)(nil),                 // 64: rpcpb.ListSubnetsRequest
	(*ListSubnetsResponse)(nil),                // 65: rpcpb.ListSubnetsResponse
	(*ListBlockchainsRequest)(nil),             // 66: rpcpb.ListBlockchainsRequest
	(*ListBlockchainsResponse)(nil),            // 67: rpcpb.ListBlockchainsResponse
	(*ListRpcsRequest)(nil),                    // 68: rpcpb.ListRpcsRequest
	(*NodeRpc)(nil),                            // 69: rpcpb.NodeRpc
	(*BlockchainRpcs)(nil),                     // 70: rpcpb.BlockchainRpcs
	(*ListRpcsResponse)(nil),                   // 71: rpcpb.ListRpcsResponse
	(*VMIDRequest)(nil),                        // 72: rpcpb.VMIDRequest
	(*VMIDResponse)(nil),                       // 73: rpcpb.VMIDResponse
	nil,                                        // 74: rpcpb.ClusterInfo.NodeInfosEntry
	nil,                                        // 75: rpcpb.ClusterInfo.AttachedPeerInfosEntry
	nil,                                        // 76: rpcpb.ClusterInfo.CustomChainsEntry
	nil,                                        // 77: rpcpb.ClusterInfo.SubnetsEntry
	nil,                                        // 78: rpcpb.StartRequest.CustomNodeConfigsEntry
	nil,                                        // 79: rpcpb.StartRequest.ChainConfigsEntry
	nil,                                        // 80: rpcpb.StartRequest.UpgradeConfigsEntry
	nil,                                        // 81: rpcpb.StartRequest.SubnetConfigsEntry
	nil,                                        // 82: rpcpb.RestartNodeRequest.ChainConfigsEntry
	nil,                                        // 83: rpcpb.RestartNodeRequest.UpgradeConfigsEntry
	nil,                                        // 84: rpcpb.RestartNodeRequest.SubnetConfigsEntry
	nil,                                        // 85: rpcpb.AddNodeRequest.ChainConfigsEntry
	nil,                                        // 86: rpcpb.AddNodeRequest.UpgradeConfigsEntry
	nil,                                        // 87: rpcpb.AddNodeRequest.SubnetConfigsEntry
	nil,                                        // 88: rpcpb.LoadSnapshotRequest.ChainConfigsEntry
...
var file_rpcpb_rpc_proto_depIdxs = []int32{
	74, // 0: rpcpb.ClusterInfo.node_infos:type_name -> rpcpb.ClusterInfo.NodeInfosEntry
	75, // 1: rpcpb.ClusterInfo.attached_peer_infos:type_name -> rpcpb.ClusterInfo.AttachedPeerInfosEntry
	76, // 2: rpcpb.ClusterInfo.custom_chains:type_name -> rpcpb.ClusterInfo.CustomChainsEntry
	77, // 3: rpcpb.ClusterInfo.subnets:type_name -> rpcpb.ClusterInfo.SubnetsEntry
	...
	25, // 6: rpcpb.StartRequest.blockchain_specs:type_name -> rpcpb.BlockchainSpec
	78, // 7: rpcpb.StartRequest.custom_node_configs:type_name -> rpcpb.StartRequest.CustomNodeConfigsEntry
	79, // 8: rpcpb.StartRequest.chain_configs:type_name -> rpcpb.StartRequest.ChainConfigsEntry
	80, // 9: rpcpb.StartRequest.upgrade_configs:type_name -> rpcpb.StartRequest.UpgradeConfigsEntry
	81, // 10: rpcpb.StartRequest.subnet_configs:type_name -> rpcpb.StartRequest.SubnetConfigsEntry
	...
	13, // 20: rpcpb.BlockchainSpec.subnet_spec:type_name -> rpcpb.SubnetSpec
	25, // 21: rpcpb.CreateBlockchainsRequest.blockchain_specs:type_name -> rpcpb.BlockchainSpec
	3,  // 22: rpcpb.CreateBlockchainsResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	13, // 23: rpcpb.CreateSubnetsRequest.subnet_specs:type_name -> rpcpb.SubnetSpec
	3,  // 24: rpcpb.CreateSubnetsResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	3,  // 25: rpcpb.HealthResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	3,  // 26: rpcpb.WaitForHealthyResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	3,  // 27: rpcpb.StatusResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	3,  // 28: rpcpb.StreamStatusResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	82, // 29: rpcpb.RestartNodeRequest.chain_configs:type_name -> rpcpb.RestartNodeRequest.ChainConfigsEntry
	83, // 30: rpcpb.RestartNodeRequest.upgrade_configs:type_name -> rpcpb.RestartNodeRequest.UpgradeConfigsEntry
	84, // 31: rpcpb.RestartNodeRequest.subnet_configs:type_name -> rpcpb.RestartNodeRequest.SubnetConfigsEntry
	3,  // 32: rpcpb.RestartNodeResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	3,  // 33: rpcpb.RemoveNodeResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	3,  // 34: rpcpb.PauseNodeResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	3,  // 35: rpcpb.ResumeNodeResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	85, // 36: rpcpb.AddNodeRequest.chain_configs:type_name -> rpcpb.AddNodeRequest.ChainConfigsEntry
	86, // 37: rpcpb.AddNodeRequest.upgrade_configs:type_name -> rpcpb.AddNodeRequest.UpgradeConfigsEntry
	87, // 38: rpcpb.AddNodeRequest.subnet_configs:type_name -> rpcpb.AddNodeRequest.SubnetConfigsEntry
	3,  // 39: rpcpb.AddNodeResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	3,  // 40: rpcpb.StopResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	3,  // 41: rpcpb.AttachPeerResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	7,  // 42: rpcpb.AttachPeerResponse.attached_peer_info:type_name -> rpcpb.AttachedPeerInfo
	...
	90, // 45: rpcpb.LoadSnapshotRequest.subnet_configs:type_name -> rpcpb.LoadSnapshotRequest.SubnetConfigsEntry
	3,  // 46: rpcpb.LoadSnapshotResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	5,  // 47: rpcpb.ListBlockchainsResponse.blockchains:type_name -> rpcpb.CustomChainInfo
	69, // 48: rpcpb.BlockchainRpcs.rpcs:type_name -> rpcpb.NodeRpc
	70, // 49: rpcpb.ListRpcsResponse.blockchains_rpcs:type_name -> rpcpb.BlockchainRpcs
	6,  // 50: rpcpb.ClusterInfo.NodeInfosEntry.value:type_name -> rpcpb.NodeInfo
	8,  // 51: rpcpb.ClusterInfo.AttachedPeerInfosEntry.value:type_name -> rpcpb.ListOfAttachedPeerInfo
	5,  // 52: rpcpb.ClusterInfo.CustomChainsEntry.value:type_name -> rpcpb.CustomChainInfo
	4,  // 53: rpcpb.ClusterInfo.SubnetsEntry.value:type_name -> rpcpb.SubnetInfo
	0,  // 54: rpcpb.PingService.Ping:input_type -> rpcpb.PingRequest
	10, // 55: rpcpb.ControlService.RPCVersion:input_type -> rpcpb.RPCVersionRequest
	9,  // 56: rpcpb.ControlService.Start:input_type -> rpcpb.StartRequest
	26, // 57: rpcpb.ControlService.CreateBlockchains:input_type -> rpcpb.CreateBlockchainsRequest
	15, // 58: rpcpb.ControlService.TransformElasticSubnets:input_type -> rpcpb.TransformElasticSubnetsRequest
	20, // 59: rpcpb.ControlService.AddPermissionlessDelegator:input_type -> rpcpb.AddPermissionlessDelegatorRequest
	18, // 60: rpcpb.ControlService.AddPermissionlessValidator:input_type -> rpcpb.AddPermissionlessValidatorRequest
	23, // 61: rpcpb.ControlService.RemoveSubnetValidator:input_type -> rpcpb.RemoveSubnetValidatorRequest
	28, // 62: rpcpb.ControlService.CreateSubnets:input_type -> rpcpb.CreateSubnetsRequest
	30, // 63: rpcpb.ControlService.Health:input_type -> rpcpb.HealthRequest
	32, // 64: rpcpb.ControlService.URIs:input_type -> rpcpb.URIsRequest
	34, // 65: rpcpb.ControlService.WaitForHealthy:input_type -> rpcpb.WaitForHealthyRequest
	36, // 66: rpcpb.ControlService.Status:input_type -> rpcpb.StatusRequest
	38, // 67: rpcpb.ControlService.StreamStatus:input_type -> rpcpb.StreamStatusRequest
	42, // 68: rpcpb.ControlService.RemoveNode:input_type -> rpcpb.RemoveNodeRequest
	48, // 69: rpcpb.ControlService.AddNode:input_type -> rpcpb.AddNodeRequest
	40, // 70: rpcpb.ControlService.RestartNode:input_type -> rpcpb.RestartNodeRequest
	44, // 71: rpcpb.ControlService.PauseNode:input_type -> rpcpb.PauseNodeRequest
	46, // 72: rpcpb.ControlService.ResumeNode:input_type -> rpcpb.ResumeNodeRequest
	50, // 73: rpcpb.ControlService.Stop:input_type -> rpcpb.StopRequest
	52, // 74: rpcpb.ControlService.AttachPeer:input_type -> rpcpb.AttachPeerRequest
	54, // 75: rpcpb.ControlService.SendOutboundMessage:input_type -> rpcpb.SendOutboundMessageRequest
	56, // 76: rpcpb.ControlService.SaveSnapshot:input_type -> rpcpb.SaveSnapshotRequest
	58, // 77: rpcpb.ControlService.LoadSnapshot:input_type -> rpcpb.LoadSnapshotRequest
	60, // 78: rpcpb.ControlService.RemoveSnapshot:input_type -> rpcpb.RemoveSnapshotRequest
	62, // 79: rpcpb.ControlService.GetSnapshotNames:input_type -> rpcpb.GetSnapshotNamesRequest
	64, // 80: rpcpb.ControlService.ListSubnets:input_type -> rpcpb.ListSubnetsRequest
	66, // 81: rpcpb.ControlService.ListBlockchains:input_type -> rpcpb.ListBlockchainsRequest
	68, // 82: rpcpb.ControlService.ListRpcs:input_type -> rpcpb.ListRpcsRequest
	72, // 83: rpcpb.ControlService.VMID:input_type -> rpcpb.VMIDRequest
	1,  // 84: rpcpb.PingService.Ping:output_type -> rpcpb.PingResponse
	11, // 85: rpcpb.ControlService.RPCVersion:output_type -> rpcpb.RPCVersionResponse
	12, // 86: rpcpb.ControlService.Start:output_type -> rpcpb.StartResponse
	27, // 87: rpcpb.ControlService.CreateBlockchains:output_type -> rpcpb.CreateBlockchainsResponse
	16, // 88: rpcpb.ControlService.TransformElasticSubnets:output_type -> rpcpb.TransformElasticSubnetsResponse
	21, // 89: rpcpb.ControlService.AddPermissionlessDelegator:output_type -> rpcpb.AddPermissionlessDelegatorResponse
	19, // 90: rpcpb.ControlService.AddPermissionlessValidator:output_type -> rpcpb.AddPermissionlessValidatorResponse
	24, // 91: rpcpb.ControlService.RemoveSubnetValidator:output_type -> rpcpb.RemoveSubnetValidatorResponse
	29, // 92: rpcpb.ControlService.CreateSubnets:output_type -> rpcpb.CreateSubnetsResponse
	31, // 93: rpcpb.ControlService.Health:output_type -> rpcpb.HealthResponse
	33, // 94: rpcpb.ControlService.URIs:output_type -> rpcpb.URIsResponse
	35, // 95: rpcpb.ControlService.WaitForHealthy:output_type -> rpcpb.WaitForHealthyResponse
	37, // 96: rpcpb.ControlService.Status:output_type -> rpcpb.StatusResponse
	39, // 97: rpcpb.ControlService.StreamStatus:output_type -> rpcpb.StreamStatusResponse
	43, // 98: rpcpb.ControlService.RemoveNode:output_type -> rpcpb.RemoveNodeResponse
	49, // 99: rpcpb.ControlService.AddNode:output_type -> rpcpb.AddNodeResponse
	41, // 100: rpcpb.ControlService.RestartNode:output_type -> rpcpb.RestartNodeResponse
	45, // 101: rpcpb.ControlService.PauseNode:output_type -> rpcpb.PauseNodeResponse
	47, // 102: rpcpb.ControlService.ResumeNode:output_type -> rpcpb.ResumeNodeResponse
	51, // 103: rpcpb.ControlService.Stop:output_type -> rpcpb.StopResponse
	53, // 104: rpcpb.ControlService.AttachPeer:output_type -> rpcpb.AttachPeerResponse
	55, // 105: rpcpb.ControlService.SendOutboundMessage:output_type -> rpcpb.SendOutboundMessageResponse
	57, // 106: rpcpb.ControlService.SaveSnapshot:output_type -> rpcpb.SaveSnapshotResponse
	59, // 107: rpcpb.ControlService.LoadSnapshot:output_type -> rpcpb.LoadSnapshotResponse
	61, // 108: rpcpb.ControlService.RemoveSnapshot:output_type -> rpcpb.RemoveSnapshotResponse
	63, // 109: rpcpb.ControlService.GetSnapshotNames:output_type -> rpcpb.GetSnapshotNamesResponse
	65, // 110: rpcpb.ControlService.ListSubnets:output_type -> rpcpb.ListSubnetsResponse
	67, // 111: rpcpb.ControlService.ListBlockchains:output_type -> rpcpb.ListBlockchainsResponse
	71, // 112: rpcpb.ControlService.ListRpcs:output_type -> rpcpb.ListRpcsResponse
	73, // 113: rpcpb.ControlService.VMID:output_type -> rpcpb.VMIDResponse
...
func file_rpcpb_rpc_proto_init() {
	...
	file_rpcpb_rpc_proto_msgTypes[25].OneofWrappers = []interface{}{}
	file_rpcpb_rpc_proto_msgTypes[40].OneofWrappers = []interface{}{}
	file_rpcpb_rpc_proto_msgTypes[48].OneofWrappers = []interface{}{}
	file_rpcpb_rpc_proto_msgTypes[58].OneofWrappers = []interface{}{}
	type x struct{}
