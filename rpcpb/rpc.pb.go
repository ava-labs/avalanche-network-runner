...
var file_rpcpb_rpc_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x05, 0x70, 0x65, 0x65, 0x72, 0x73, 0x22, 0xd2, 0x05,
	...
	0x0c, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x73, 0x1a, 0x44, 0x0a,
	...
	0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x73, 0x0a, 0x0e, 0x42, 0x6c,
	...
	0x01, 0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x73, 0x75, 0x62, 0x6e, 0x65, 0x74, 0x5f, 0x69, 0x64, 0x22,
	...
	0x32, 0x12, 0x2e, 0x72, 0x70, 0x63, 0x70, 0x62, 0x2e, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72,
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x0b, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x49, 0x6e, 0x66,
	0x6f, 0x22, 0xb9, 0x02, 0x0a, 0x12, 0x52, 0x65, 0x73, 0x74, 0x61, 0x72, 0x74, 0x4e, 0x6f, 0x64,
	...
	0x32, 0x12, 0x2e, 0x72, 0x70, 0x63, 0x70, 0x62, 0x2e, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72,
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x0b, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x49, 0x6e, 0x66,
	0x6f, 0x22, 0x86, 0x02, 0x0a, 0x0e, 0x41, 0x64, 0x64, 0x4e, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x71,
	...
	0x69, 0x6e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x73, 0x1a, 0x3f, 0x0a, 0x11, 0x43, 0x68, 0x61,
	...
	0x68, 0x6f, 0x74, 0x50, 0x61, 0x74, 0x68, 0x22, 0xb6, 0x03, 0x0a, 0x13, 0x4c, 0x6f, 0x61, 0x64,
	...
	0x5f, 0x6e, 0x6f, 0x64, 0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x06, 0x20, 0x01,
	0x28, 0x09, 0x48, 0x03, 0x52, 0x10, 0x67, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x4e, 0x6f, 0x64, 0x65,
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x88, 0x01, 0x01, 0x1a, 0x3f, 0x0a, 0x11, 0x43, 0x68, 0x61,
	0x69, 0x6e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10,
	0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79,
	0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
...
var file_rpcpb_rpc_proto_goTypes = []interface{}{
	...
	nil,                                 // 47: rpcpb.RestartNodeRequest.ChainConfigsEntry
...
var file_rpcpb_rpc_proto_depIdxs = []int32{
	...
	47, // 14: rpcpb.RestartNodeRequest.chain_configs:type_name -> rpcpb.RestartNodeRequest.ChainConfigsEntry
	2,  // 15: rpcpb.RestartNodeResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	2,  // 16: rpcpb.RemoveNodeResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	48, // 17: rpcpb.AddNodeRequest.chain_configs:type_name -> rpcpb.AddNodeRequest.ChainConfigsEntry
	2,  // 18: rpcpb.AddNodeResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	2,  // 19: rpcpb.StopResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	2,  // 20: rpcpb.AttachPeerResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	5,  // 21: rpcpb.AttachPeerResponse.attached_peer_info:type_name -> rpcpb.AttachedPeerInfo
	49, // 22: rpcpb.LoadSnapshotRequest.chain_configs:type_name -> rpcpb.LoadSnapshotRequest.ChainConfigsEntry
	2,  // 23: rpcpb.LoadSnapshotResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	4,  // 24: rpcpb.ClusterInfo.NodeInfosEntry.value:type_name -> rpcpb.NodeInfo
	6,  // 25: rpcpb.ClusterInfo.AttachedPeerInfosEntry.value:type_name -> rpcpb.ListOfAttachedPeerInfo
	3,  // 26: rpcpb.ClusterInfo.CustomChainsEntry.value:type_name -> rpcpb.CustomChainInfo
	0,  // 27: rpcpb.PingService.Ping:input_type -> rpcpb.PingRequest
	7,  // 28: rpcpb.ControlService.Start:input_type -> rpcpb.StartRequest
	10, // 29: rpcpb.ControlService.CreateBlockchains:input_type -> rpcpb.CreateBlockchainsRequest
	12, // 30: rpcpb.ControlService.CreateSubnets:input_type -> rpcpb.CreateSubnetsRequest
	14, // 31: rpcpb.ControlService.Health:input_type -> rpcpb.HealthRequest
	16, // 32: rpcpb.ControlService.URIs:input_type -> rpcpb.URIsRequest
	18, // 33: rpcpb.ControlService.Status:input_type -> rpcpb.StatusRequest
	20, // 34: rpcpb.ControlService.StreamStatus:input_type -> rpcpb.StreamStatusRequest
	24, // 35: rpcpb.ControlService.RemoveNode:input_type -> rpcpb.RemoveNodeRequest
	26, // 36: rpcpb.ControlService.AddNode:input_type -> rpcpb.AddNodeRequest
	22, // 37: rpcpb.ControlService.RestartNode:input_type -> rpcpb.RestartNodeRequest
	28, // 38: rpcpb.ControlService.Stop:input_type -> rpcpb.StopRequest
	30, // 39: rpcpb.ControlService.AttachPeer:input_type -> rpcpb.AttachPeerRequest
	32, // 40: rpcpb.ControlService.SendOutboundMessage:input_type -> rpcpb.SendOutboundMessageRequest
	34, // 41: rpcpb.ControlService.SaveSnapshot:input_type -> rpcpb.SaveSnapshotRequest
	36, // 42: rpcpb.ControlService.LoadSnapshot:input_type -> rpcpb.LoadSnapshotRequest
	38, // 43: rpcpb.ControlService.RemoveSnapshot:input_type -> rpcpb.RemoveSnapshotRequest
	40, // 44: rpcpb.ControlService.GetSnapshotNames:input_type -> rpcpb.GetSnapshotNamesRequest
	1,  // 45: rpcpb.PingService.Ping:output_type -> rpcpb.PingResponse
	8,  // 46: rpcpb.ControlService.Start:output_type -> rpcpb.StartResponse
	11, // 47: rpcpb.ControlService.CreateBlockchains:output_type -> rpcpb.CreateBlockchainsResponse
	13, // 48: rpcpb.ControlService.CreateSubnets:output_type -> rpcpb.CreateSubnetsResponse
	15, // 49: rpcpb.ControlService.Health:output_type -> rpcpb.HealthResponse
	17, // 50: rpcpb.ControlService.URIs:output_type -> rpcpb.URIsResponse
	19, // 51: rpcpb.ControlService.Status:output_type -> rpcpb.StatusResponse
	21, // 52: rpcpb.ControlService.StreamStatus:output_type -> rpcpb.StreamStatusResponse
	25, // 53: rpcpb.ControlService.RemoveNode:output_type -> rpcpb.RemoveNodeResponse
	27, // 54: rpcpb.ControlService.AddNode:output_type -> rpcpb.AddNodeResponse
	23, // 55: rpcpb.ControlService.RestartNode:output_type -> rpcpb.RestartNodeResponse
	29, // 56: rpcpb.ControlService.Stop:output_type -> rpcpb.StopResponse
	31, // 57: rpcpb.ControlService.AttachPeer:output_type -> rpcpb.AttachPeerResponse
	33, // 58: rpcpb.ControlService.SendOutboundMessage:output_type -> rpcpb.SendOutboundMessageResponse
	35, // 59: rpcpb.ControlService.SaveSnapshot:output_type -> rpcpb.SaveSnapshotResponse
	37, // 60: rpcpb.ControlService.LoadSnapshot:output_type -> rpcpb.LoadSnapshotResponse
	39, // 61: rpcpb.ControlService.RemoveSnapshot:output_type -> rpcpb.RemoveSnapshotResponse
	41, // 62: rpcpb.ControlService.GetSnapshotNames:output_type -> rpcpb.GetSnapshotNamesResponse
