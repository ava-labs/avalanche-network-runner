...
var file_rpcpb_rpc_proto_rawDesc = []byte{
	...
	0x6f, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x30, 0x0a, 0x11, 0x41, 0x74,
	...
	0x02, 0x0d, 0x3a, 0x01, 0x2a, 0x22, 0x08, 0x2f, 0x76, 0x31, 0x2f, 0x70, 0x69, 0x6e, 0x67, 0x32,
...
var file_rpcpb_rpc_proto_depIdxs = []int32{
	...
	57, // 28: rpcpb.LoadSnapshotRequest.chain_configs:type_name -> rpcpb.LoadSnapshotRequest.ChainConfigsEntry
	58, // 29: rpcpb.LoadSnapshotRequest.upgrade_configs:type_name -> rpcpb.LoadSnapshotRequest.UpgradeConfigsEntry
	59, // 30: rpcpb.LoadSnapshotRequest.subnet_configs:type_name -> rpcpb.LoadSnapshotRequest.SubnetConfigsEntry
	...
	18, // 41: rpcpb.ControlService.WaitForHealthy:input_type -> rpcpb.WaitForHealthyRequest
	20, // 42: rpcpb.ControlService.Status:input_type -> rpcpb.StatusRequest
	22, // 43: rpcpb.ControlService.StreamStatus:input_type -> rpcpb.StreamStatusRequest
	26, // 44: rpcpb.ControlService.RemoveNode:input_type -> rpcpb.RemoveNodeRequest
	28, // 45: rpcpb.ControlService.AddNode:input_type -> rpcpb.AddNodeRequest
	24, // 46: rpcpb.ControlService.RestartNode:input_type -> rpcpb.RestartNodeRequest
	30, // 47: rpcpb.ControlService.Stop:input_type -> rpcpb.StopRequest
	32, // 48: rpcpb.ControlService.AttachPeer:input_type -> rpcpb.AttachPeerRequest
	34, // 49: rpcpb.ControlService.SendOutboundMessage:input_type -> rpcpb.SendOutboundMessageRequest
	36, // 50: rpcpb.ControlService.SaveSnapshot:input_type -> rpcpb.SaveSnapshotRequest
	38, // 51: rpcpb.ControlService.LoadSnapshot:input_type -> rpcpb.LoadSnapshotRequest
	40, // 52: rpcpb.ControlService.RemoveSnapshot:input_type -> rpcpb.RemoveSnapshotRequest
	42, // 53: rpcpb.ControlService.GetSnapshotNames:input_type -> rpcpb.GetSnapshotNamesRequest
	...
	19, // 60: rpcpb.ControlService.WaitForHealthy:output_type -> rpcpb.WaitForHealthyResponse
	21, // 61: rpcpb.ControlService.Status:output_type -> rpcpb.StatusResponse
	23, // 62: rpcpb.ControlService.StreamStatus:output_type -> rpcpb.StreamStatusResponse
	27, // 63: rpcpb.ControlService.RemoveNode:output_type -> rpcpb.RemoveNodeResponse
	29, // 64: rpcpb.ControlService.AddNode:output_type -> rpcpb.AddNodeResponse
	25, // 65: rpcpb.ControlService.RestartNode:output_type -> rpcpb.RestartNodeResponse
	31, // 66: rpcpb.ControlService.Stop:output_type -> rpcpb.StopResponse
	33, // 67: rpcpb.ControlService.AttachPeer:output_type -> rpcpb.AttachPeerResponse
	35, // 68: rpcpb.ControlService.SendOutboundMessage:output_type -> rpcpb.SendOutboundMessageResponse
	37, // 69: rpcpb.ControlService.SaveSnapshot:output_type -> rpcpb.SaveSnapshotResponse
	39, // 70: rpcpb.ControlService.LoadSnapshot:output_type -> rpcpb.LoadSnapshotResponse
	41, // 71: rpcpb.ControlService.RemoveSnapshot:output_type -> rpcpb.RemoveSnapshotResponse
	43, // 72: rpcpb.ControlService.GetSnapshotNames:output_type -> rpcpb.GetSnapshotNamesResponse
