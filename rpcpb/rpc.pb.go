...
var file_rpcpb_rpc_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x49, 0x64, 0x22, 0x9c, 0x02, 0x0a, 0x08, 0x4e, 0x6f, 0x64, 0x65, 0x49, 0x6e, 0x66,
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x25, 0x0a, 0x0e,
	0x75, 0x70, 0x67, 0x72, 0x61, 0x64, 0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x0a,
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x0d, 0x75, 0x70, 0x67, 0x72, 0x61, 0x64, 0x65, 0x43, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x22, 0x22, 0x0a, 0x10, 0x41, 0x74, 0x74, 0x61, 0x63, 0x68, 0x65, 0x64, 0x50,
	...
	0x22, 0xa6, 0x07, 0x0a, 0x0c, 0x53, 0x74, 0x61, 0x72, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x01, 0x01, 0x12, 0x22, 0x0a, 0x0a, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x5f, 0x64, 0x69, 0x72,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x48, 0x04, 0x52, 0x09, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e,
	0x44, 0x69, 0x72, 0x88, 0x01, 0x01, 0x12, 0x41, 0x0a, 0x0a, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d,
	0x5f, 0x76, 0x6d, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x72, 0x70, 0x63,
	0x70, 0x62, 0x2e, 0x53, 0x74, 0x61, 0x72, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e,
	0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x56, 0x6d, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x09,
	0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x56, 0x6d, 0x73, 0x12, 0x5a, 0x0a, 0x13, 0x63, 0x75, 0x73,
	...
	0x01, 0x1a, 0x44, 0x0a, 0x16, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x4e, 0x6f, 0x64, 0x65, 0x43,
	...
	0x6f, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x72, 0x70, 0x63, 0x70, 0x62, 0x2e,
	0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x0b, 0x63, 0x6c, 0x75,
	0x73, 0x74, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x8f, 0x04, 0x0a, 0x12, 0x52, 0x65, 0x73,
	...
	0x72, 0x88, 0x01, 0x01, 0x12, 0x50, 0x0a, 0x0d, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x5f, 0x63, 0x6f,
	0x6e, 0x66, 0x69, 0x67, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x72, 0x70,
	...
	0x75, 0x70, 0x67, 0x72, 0x61, 0x64, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x73, 0x1a, 0x3f,
...
var file_rpcpb_rpc_proto_msgTypes = make([]protoimpl.MessageInfo, 52)
...
var file_rpcpb_rpc_proto_depIdxs = []int32{
	...
	48, // 7: rpcpb.StartRequest.upgrade_configs:type_name -> rpcpb.StartRequest.UpgradeConfigsEntry
	...
	49, // 15: rpcpb.RestartNodeRequest.chain_configs:type_name -> rpcpb.RestartNodeRequest.ChainConfigsEntry
	50, // 16: rpcpb.RestartNodeRequest.upgrade_configs:type_name -> rpcpb.RestartNodeRequest.UpgradeConfigsEntry
	...
	7,  // 19: rpcpb.AddNodeRequest.start_request:type_name -> rpcpb.StartRequest
	2,  // 20: rpcpb.AddNodeResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	2,  // 21: rpcpb.StopResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	2,  // 22: rpcpb.AttachPeerResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	5,  // 23: rpcpb.AttachPeerResponse.attached_peer_info:type_name -> rpcpb.AttachedPeerInfo
	51, // 24: rpcpb.LoadSnapshotRequest.chain_configs:type_name -> rpcpb.LoadSnapshotRequest.ChainConfigsEntry
	2,  // 25: rpcpb.LoadSnapshotResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	4,  // 26: rpcpb.ClusterInfo.NodeInfosEntry.value:type_name -> rpcpb.NodeInfo
	6,  // 27: rpcpb.ClusterInfo.AttachedPeerInfosEntry.value:type_name -> rpcpb.ListOfAttachedPeerInfo
	3,  // 28: rpcpb.ClusterInfo.CustomVmsEntry.value:type_name -> rpcpb.CustomVmInfo
	0,  // 29: rpcpb.PingService.Ping:input_type -> rpcpb.PingRequest
	7,  // 30: rpcpb.ControlService.Start:input_type -> rpcpb.StartRequest
	10, // 31: rpcpb.ControlService.CreateBlockchains:input_type -> rpcpb.CreateBlockchainsRequest
	12, // 32: rpcpb.ControlService.CreateSubnets:input_type -> rpcpb.CreateSubnetsRequest
	14, // 33: rpcpb.ControlService.Health:input_type -> rpcpb.HealthRequest
	16, // 34: rpcpb.ControlService.URIs:input_type -> rpcpb.URIsRequest
	18, // 35: rpcpb.ControlService.Status:input_type -> rpcpb.StatusRequest
	20, // 36: rpcpb.ControlService.StreamStatus:input_type -> rpcpb.StreamStatusRequest
	24, // 37: rpcpb.ControlService.RemoveNode:input_type -> rpcpb.RemoveNodeRequest
	26, // 38: rpcpb.ControlService.AddNode:input_type -> rpcpb.AddNodeRequest
	22, // 39: rpcpb.ControlService.RestartNode:input_type -> rpcpb.RestartNodeRequest
	28, // 40: rpcpb.ControlService.Stop:input_type -> rpcpb.StopRequest
	30, // 41: rpcpb.ControlService.AttachPeer:input_type -> rpcpb.AttachPeerRequest
	32, // 42: rpcpb.ControlService.SendOutboundMessage:input_type -> rpcpb.SendOutboundMessageRequest
	34, // 43: rpcpb.ControlService.SaveSnapshot:input_type -> rpcpb.SaveSnapshotRequest
	36, // 44: rpcpb.ControlService.LoadSnapshot:input_type -> rpcpb.LoadSnapshotRequest
	38, // 45: rpcpb.ControlService.RemoveSnapshot:input_type -> rpcpb.RemoveSnapshotRequest
	40, // 46: rpcpb.ControlService.GetSnapshotNames:input_type -> rpcpb.GetSnapshotNamesRequest
	1,  // 47: rpcpb.PingService.Ping:output_type -> rpcpb.PingResponse
	8,  // 48: rpcpb.ControlService.Start:output_type -> rpcpb.StartResponse
	11, // 49: rpcpb.ControlService.CreateBlockchains:output_type -> rpcpb.CreateBlockchainsResponse
	13, // 50: rpcpb.ControlService.CreateSubnets:output_type -> rpcpb.CreateSubnetsResponse
	15, // 51: rpcpb.ControlService.Health:output_type -> rpcpb.HealthResponse
	17, // 52: rpcpb.ControlService.URIs:output_type -> rpcpb.URIsResponse
	19, // 53: rpcpb.ControlService.Status:output_type -> rpcpb.StatusResponse
	21, // 54: rpcpb.ControlService.StreamStatus:output_type -> rpcpb.StreamStatusResponse
	25, // 55: rpcpb.ControlService.RemoveNode:output_type -> rpcpb.RemoveNodeResponse
	27, // 56: rpcpb.ControlService.AddNode:output_type -> rpcpb.AddNodeResponse
	23, // 57: rpcpb.ControlService.RestartNode:output_type -> rpcpb.RestartNodeResponse
	29, // 58: rpcpb.ControlService.Stop:output_type -> rpcpb.StopResponse
	31, // 59: rpcpb.ControlService.AttachPeer:output_type -> rpcpb.AttachPeerResponse
	33, // 60: rpcpb.ControlService.SendOutboundMessage:output_type -> rpcpb.SendOutboundMessageResponse
	35, // 61: rpcpb.ControlService.SaveSnapshot:output_type -> rpcpb.SaveSnapshotResponse
	37, // 62: rpcpb.ControlService.LoadSnapshot:output_type -> rpcpb.LoadSnapshotResponse
	39, // 63: rpcpb.ControlService.RemoveSnapshot:output_type -> rpcpb.RemoveSnapshotResponse
	41, // 64: rpcpb.ControlService.GetSnapshotNames:output_type -> rpcpb.GetSnapshotNamesResponse
