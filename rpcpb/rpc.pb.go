...
var file_rpcpb_rpc_proto_rawDesc = []byte{
	...
	0x67, 0x22, 0xc2, 0x02, 0x0a, 0x0e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x63, 0x68, 0x61, 0x69, 0x6e,
	...
	0x74, 0x53, 0x70, 0x65, 0x63, 0x73, 0x22, 0x4e, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x70, 0x69, 0x6e, 0x67, 0x32, 0x9e, 0x11, 0x0a, 0x0e, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c,
	...
	0x6e, 0x73, 0x12, 0x70, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x75, 0x62, 0x6e,
...
var file_rpcpb_rpc_proto_msgTypes = make([]protoimpl.MessageInfo, 67)
var file_rpcpb_rpc_proto_goTypes = []interface{}{
	...
	(*BlockchainSpec)(nil),              // 12: rpcpb.BlockchainSpec
	(*CreateBlockchainsRequest)(nil),    // 13: rpcpb.CreateBlockchainsRequest
	(*CreateBlockchainsResponse)(nil),   // 14: rpcpb.CreateBlockchainsResponse
	(*CreateSubnetsRequest)(nil),        // 15: rpcpb.CreateSubnetsRequest
	(*CreateSubnetsResponse)(nil),       // 16: rpcpb.CreateSubnetsResponse
	(*HealthRequest)(nil),               // 17: rpcpb.HealthRequest
	(*HealthResponse)(nil),              // 18: rpcpb.HealthResponse
	(*URIsRequest)(nil),                 // 19: rpcpb.URIsRequest
	(*URIsResponse)(nil),                // 20: rpcpb.URIsResponse
	(*WaitForHealthyRequest)(nil),       // 21: rpcpb.WaitForHealthyRequest
	(*WaitForHealthyResponse)(nil),      // 22: rpcpb.WaitForHealthyResponse
	(*StatusRequest)(nil),               // 23: rpcpb.StatusRequest
	(*StatusResponse)(nil),              // 24: rpcpb.StatusResponse
	(*StreamStatusRequest)(nil),         // 25: rpcpb.StreamStatusRequest
	(*StreamStatusResponse)(nil),        // 26: rpcpb.StreamStatusResponse
	(*RestartNodeRequest)(nil),          // 27: rpcpb.RestartNodeRequest
	(*RestartNodeResponse)(nil),         // 28: rpcpb.RestartNodeResponse
	(*RemoveNodeRequest)(nil),           // 29: rpcpb.RemoveNodeRequest
	(*RemoveNodeResponse)(nil),          // 30: rpcpb.RemoveNodeResponse
	(*PauseNodeRequest)(nil),            // 31: rpcpb.PauseNodeRequest
	(*PauseNodeResponse)(nil),           // 32: rpcpb.PauseNodeResponse
	(*ResumeNodeRequest)(nil),           // 33: rpcpb.ResumeNodeRequest
	(*ResumeNodeResponse)(nil),          // 34: rpcpb.ResumeNodeResponse
	(*AddNodeRequest)(nil),              // 35: rpcpb.AddNodeRequest
	(*AddNodeResponse)(nil),             // 36: rpcpb.AddNodeResponse
	(*StopRequest)(nil),                 // 37: rpcpb.StopRequest
	(*StopResponse)(nil),                // 38: rpcpb.StopResponse
	(*AttachPeerRequest)(nil),           // 39: rpcpb.AttachPeerRequest
	(*AttachPeerResponse)(nil),          // 40: rpcpb.AttachPeerResponse
	(*SendOutboundMessageRequest)(nil),  // 41: rpcpb.SendOutboundMessageRequest
	(*SendOutboundMessageResponse)(nil), // 42: rpcpb.SendOutboundMessageResponse
	(*SaveSnapshotRequest)(nil),         // 43: rpcpb.SaveSnapshotRequest
	(*SaveSnapshotResponse)(nil),        // 44: rpcpb.SaveSnapshotResponse
	(*LoadSnapshotRequest)(nil),         // 45: rpcpb.LoadSnapshotRequest
	(*LoadSnapshotResponse)(nil),        // 46: rpcpb.LoadSnapshotResponse
	(*RemoveSnapshotRequest)(nil),       // 47: rpcpb.RemoveSnapshotRequest
	(*RemoveSnapshotResponse)(nil),      // 48: rpcpb.RemoveSnapshotResponse
	(*GetSnapshotNamesRequest)(nil),     // 49: rpcpb.GetSnapshotNamesRequest
	(*GetSnapshotNamesResponse)(nil),    // 50: rpcpb.GetSnapshotNamesResponse
	nil,                                 // 51: rpcpb.ClusterInfo.NodeInfosEntry
	nil,                                 // 52: rpcpb.ClusterInfo.AttachedPeerInfosEntry
	nil,                                 // 53: rpcpb.ClusterInfo.CustomChainsEntry
	nil,                                 // 54: rpcpb.StartRequest.CustomNodeConfigsEntry
	nil,                                 // 55: rpcpb.StartRequest.ChainConfigsEntry
	nil,                                 // 56: rpcpb.StartRequest.UpgradeConfigsEntry
	nil,                                 // 57: rpcpb.StartRequest.SubnetConfigsEntry
	nil,                                 // 58: rpcpb.RestartNodeRequest.ChainConfigsEntry
	nil,                                 // 59: rpcpb.RestartNodeRequest.UpgradeConfigsEntry
	nil,                                 // 60: rpcpb.RestartNodeRequest.SubnetConfigsEntry
	nil,                                 // 61: rpcpb.AddNodeRequest.ChainConfigsEntry
	nil,                                 // 62: rpcpb.AddNodeRequest.UpgradeConfigsEntry
	nil,                                 // 63: rpcpb.AddNodeRequest.SubnetConfigsEntry
	nil,                                 // 64: rpcpb.LoadSnapshotRequest.ChainConfigsEntry
	nil,                                 // 65: rpcpb.LoadSnapshotRequest.UpgradeConfigsEntry
	nil,                                 // 66: rpcpb.LoadSnapshotRequest.SubnetConfigsEntry
}
var file_rpcpb_rpc_proto_depIdxs = []int32{
	51, // 0: rpcpb.ClusterInfo.node_infos:type_name -> rpcpb.ClusterInfo.NodeInfosEntry
	52, // 1: rpcpb.ClusterInfo.attached_peer_infos:type_name -> rpcpb.ClusterInfo.AttachedPeerInfosEntry
	53, // 2: rpcpb.ClusterInfo.custom_chains:type_name -> rpcpb.ClusterInfo.CustomChainsEntry
	5,  // 3: rpcpb.ListOfAttachedPeerInfo.peers:type_name -> rpcpb.AttachedPeerInfo
	12, // 4: rpcpb.StartRequest.blockchain_specs:type_name -> rpcpb.BlockchainSpec
	54, // 5: rpcpb.StartRequest.custom_node_configs:type_name -> rpcpb.StartRequest.CustomNodeConfigsEntry
	55, // 6: rpcpb.StartRequest.chain_configs:type_name -> rpcpb.StartRequest.ChainConfigsEntry
	56, // 7: rpcpb.StartRequest.upgrade_configs:type_name -> rpcpb.StartRequest.UpgradeConfigsEntry
	57, // 8: rpcpb.StartRequest.subnet_configs:type_name -> rpcpb.StartRequest.SubnetConfigsEntry
	2,  // 9: rpcpb.StartResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	12, // 10: rpcpb.CreateBlockchainsRequest.blockchain_specs:type_name -> rpcpb.BlockchainSpec
	2,  // 11: rpcpb.CreateBlockchainsResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	11, // 12: rpcpb.CreateSubnetsRequest.subnet_specs:type_name -> rpcpb.SubnetSpec
	2,  // 13: rpcpb.CreateSubnetsResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	2,  // 14: rpcpb.HealthResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	2,  // 15: rpcpb.WaitForHealthyResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	2,  // 16: rpcpb.StatusResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	2,  // 17: rpcpb.StreamStatusResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	58, // 18: rpcpb.RestartNodeRequest.chain_configs:type_name -> rpcpb.RestartNodeRequest.ChainConfigsEntry
	59, // 19: rpcpb.RestartNodeRequest.upgrade_configs:type_name -> rpcpb.RestartNodeRequest.UpgradeConfigsEntry
	60, // 20: rpcpb.RestartNodeRequest.subnet_configs:type_name -> rpcpb.RestartNodeRequest.SubnetConfigsEntry
	2,  // 21: rpcpb.RestartNodeResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	2,  // 22: rpcpb.RemoveNodeResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	2,  // 23: rpcpb.PauseNodeResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	2,  // 24: rpcpb.ResumeNodeResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	61, // 25: rpcpb.AddNodeRequest.chain_configs:type_name -> rpcpb.AddNodeRequest.ChainConfigsEntry
	62, // 26: rpcpb.AddNodeRequest.upgrade_configs:type_name -> rpcpb.AddNodeRequest.UpgradeConfigsEntry
	63, // 27: rpcpb.AddNodeRequest.subnet_configs:type_name -> rpcpb.AddNodeRequest.SubnetConfigsEntry
	2,  // 28: rpcpb.AddNodeResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	2,  // 29: rpcpb.StopResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	2,  // 30: rpcpb.AttachPeerResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	5,  // 31: rpcpb.AttachPeerResponse.attached_peer_info:type_name -> rpcpb.AttachedPeerInfo
	64, // 32: rpcpb.LoadSnapshotRequest.chain_configs:type_name -> rpcpb.LoadSnapshotRequest.ChainConfigsEntry
	65, // 33: rpcpb.LoadSnapshotRequest.upgrade_configs:type_name -> rpcpb.LoadSnapshotRequest.UpgradeConfigsEntry
	66, // 34: rpcpb.LoadSnapshotRequest.subnet_configs:type_name -> rpcpb.LoadSnapshotRequest.SubnetConfigsEntry
	2,  // 35: rpcpb.LoadSnapshotResponse.cluster_info:type_name -> rpcpb.ClusterInfo
	4,  // 36: rpcpb.ClusterInfo.NodeInfosEntry.value:type_name -> rpcpb.NodeInfo
	6,  // 37: rpcpb.ClusterInfo.AttachedPeerInfosEntry.value:type_name -> rpcpb.ListOfAttachedPeerInfo
	3,  // 38: rpcpb.ClusterInfo.CustomChainsEntry.value:type_name -> rpcpb.CustomChainInfo
	0,  // 39: rpcpb.PingService.Ping:input_type -> rpcpb.PingRequest
	8,  // 40: rpcpb.ControlService.RPCVersion:input_type -> rpcpb.RPCVersionRequest
	7,  // 41: rpcpb.ControlService.Start:input_type -> rpcpb.StartRequest
	13, // 42: rpcpb.ControlService.CreateBlockchains:input_type -> rpcpb.CreateBlockchainsRequest
	15, // 43: rpcpb.ControlService.CreateSubnets:input_type -> rpcpb.CreateSubnetsRequest
	17, // 44: rpcpb.ControlService.Health:input_type -> rpcpb.HealthRequest
	19, // 45: rpcpb.ControlService.URIs:input_type -> rpcpb.URIsRequest
	21, // 46: rpcpb.ControlService.WaitForHealthy:input_type -> rpcpb.WaitForHealthyRequest
	23, // 47: rpcpb.ControlService.Status:input_type -> rpcpb.StatusRequest
	25, // 48: rpcpb.ControlService.StreamStatus:input_type -> rpcpb.StreamStatusRequest
	29, // 49: rpcpb.ControlService.RemoveNode:input_type -> rpcpb.RemoveNodeRequest
	35, // 50: rpcpb.ControlService.AddNode:input_type -> rpcpb.AddNodeRequest
	27, // 51: rpcpb.ControlService.RestartNode:input_type -> rpcpb.RestartNodeRequest
	31, // 52: rpcpb.ControlService.PauseNode:input_type -> rpcpb.PauseNodeRequest
	33, // 53: rpcpb.ControlService.ResumeNode:input_type -> rpcpb.ResumeNodeRequest
	37, // 54: rpcpb.ControlService.Stop:input_type -> rpcpb.StopRequest
	39, // 55: rpcpb.ControlService.AttachPeer:input_type -> rpcpb.AttachPeerRequest
	41, // 56: rpcpb.ControlService.SendOutboundMessage:input_type -> rpcpb.SendOutboundMessageRequest
	43, // 57: rpcpb.ControlService.SaveSnapshot:input_type -> rpcpb.SaveSnapshotRequest
	45, // 58: rpcpb.ControlService.LoadSnapshot:input_type -> rpcpb.LoadSnapshotRequest
	47, // 59: rpcpb.ControlService.RemoveSnapshot:input_type -> rpcpb.RemoveSnapshotRequest
	49, // 60: rpcpb.ControlService.GetSnapshotNames:input_type -> rpcpb.GetSnapshotNamesRequest
	1,  // 61: rpcpb.PingService.Ping:output_type -> rpcpb.PingResponse
	9,  // 62: rpcpb.ControlService.RPCVersion:output_type -> rpcpb.RPCVersionResponse
	10, // 63: rpcpb.ControlService.Start:output_type -> rpcpb.StartResponse
	14, // 64: rpcpb.ControlService.CreateBlockchains:output_type -> rpcpb.CreateBlockchainsResponse
	16, // 65: rpcpb.ControlService.CreateSubnets:output_type -> rpcpb.CreateSubnetsResponse
	18, // 66: rpcpb.ControlService.Health:output_type -> rpcpb.HealthResponse
	20, // 67: rpcpb.ControlService.URIs:output_type -> rpcpb.URIsResponse
	22, // 68: rpcpb.ControlService.WaitForHealthy:output_type -> rpcpb.WaitForHealthyResponse
	24, // 69: rpcpb.ControlService.Status:output_type -> rpcpb.StatusResponse
	26, // 70: rpcpb.ControlService.StreamStatus:output_type -> rpcpb.StreamStatusResponse
	30, // 71: rpcpb.ControlService.RemoveNode:output_type -> rpcpb.RemoveNodeResponse
	36, // 72: rpcpb.ControlService.AddNode:output_type -> rpcpb.AddNodeResponse
	28, // 73: rpcpb.ControlService.RestartNode:output_type -> rpcpb.RestartNodeResponse
	32, // 74: rpcpb.ControlService.PauseNode:output_type -> rpcpb.PauseNodeResponse
	34, // 75: rpcpb.ControlService.ResumeNode:output_type -> rpcpb.ResumeNodeResponse
	38, // 76: rpcpb.ControlService.Stop:output_type -> rpcpb.StopResponse
	40, // 77: rpcpb.ControlService.AttachPeer:output_type -> rpcpb.AttachPeerResponse
	42, // 78: rpcpb.ControlService.SendOutboundMessage:output_type -> rpcpb.SendOutboundMessageResponse
	44, // 79: rpcpb.ControlService.SaveSnapshot:output_type -> rpcpb.SaveSnapshotResponse
	46, // 80: rpcpb.ControlService.LoadSnapshot:output_type -> rpcpb.LoadSnapshotResponse
	48, // 81: rpcpb.ControlService.RemoveSnapshot:output_type -> rpcpb.RemoveSnapshotResponse
	50, // 82: rpcpb.ControlService.GetSnapshotNames:output_type -> rpcpb.GetSnapshotNamesResponse
...
func file_rpcpb_rpc_proto_init() {
	...
	file_rpcpb_rpc_proto_msgTypes[45].OneofWrappers = []interface{}{}
	type x struct{}
