...
var file_rpcpb_rpc_proto_rawDesc = []byte{
	...
	0x70, 0x69, 0x6e, 0x67, 0x32, 0xd6, 0x0f, 0x0a, 0x0e, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c,
	...
	0x6f, 0x6c, 0x2f, 0x72, 0x65, 0x73, 0x74, 0x61, 0x72, 0x74, 0x6e, 0x6f, 0x64, 0x65, 0x12, 0x4c,
...
var file_rpcpb_rpc_proto_depIdxs = []int32{
	...
	59, // 28: rpcpb.LoadSnapshotRequest.chain_configs:type_name -> rpcpb.LoadSnapshotRequest.ChainConfigsEntry
	60, // 29: rpcpb.LoadSnapshotRequest.upgrade_configs:type_name -> rpcpb.LoadSnapshotRequest.UpgradeConfigsEntry
	61, // 30: rpcpb.LoadSnapshotRequest.subnet_configs:type_name -> rpcpb.LoadSnapshotRequest.SubnetConfigsEntry
	...
	8,  // 36: rpcpb.ControlService.RPCVersion:input_type -> rpcpb.RPCVersionRequest
	7,  // 37: rpcpb.ControlService.Start:input_type -> rpcpb.StartRequest
	12, // 38: rpcpb.ControlService.CreateBlockchains:input_type -> rpcpb.CreateBlockchainsRequest
	14, // 39: rpcpb.ControlService.CreateSubnets:input_type -> rpcpb.CreateSubnetsRequest
	16, // 40: rpcpb.ControlService.Health:input_type -> rpcpb.HealthRequest
	18, // 41: rpcpb.ControlService.URIs:input_type -> rpcpb.URIsRequest
	20, // 42: rpcpb.ControlService.WaitForHealthy:input_type -> rpcpb.WaitForHealthyRequest
	22, // 43: rpcpb.ControlService.Status:input_type -> rpcpb.StatusRequest
	24, // 44: rpcpb.ControlService.StreamStatus:input_type -> rpcpb.StreamStatusRequest
	28, // 45: rpcpb.ControlService.RemoveNode:input_type -> rpcpb.RemoveNodeRequest
	30, // 46: rpcpb.ControlService.AddNode:input_type -> rpcpb.AddNodeRequest
	26, // 47: rpcpb.ControlService.RestartNode:input_type -> rpcpb.RestartNodeRequest
	32, // 48: rpcpb.ControlService.Stop:input_type -> rpcpb.StopRequest
	34, // 49: rpcpb.ControlService.AttachPeer:input_type -> rpcpb.AttachPeerRequest
	36, // 50: rpcpb.ControlService.SendOutboundMessage:input_type -> rpcpb.SendOutboundMessageRequest
	38, // 51: rpcpb.ControlService.SaveSnapshot:input_type -> rpcpb.SaveSnapshotRequest
	40, // 52: rpcpb.ControlService.LoadSnapshot:input_type -> rpcpb.LoadSnapshotRequest
	42, // 53: rpcpb.ControlService.RemoveSnapshot:input_type -> rpcpb.RemoveSnapshotRequest
	44, // 54: rpcpb.ControlService.GetSnapshotNames:input_type -> rpcpb.GetSnapshotNamesRequest
	1,  // 55: rpcpb.PingService.Ping:output_type -> rpcpb.PingResponse
	9,  // 56: rpcpb.ControlService.RPCVersion:output_type -> rpcpb.RPCVersionResponse
	10, // 57: rpcpb.ControlService.Start:output_type -> rpcpb.StartResponse
	13, // 58: rpcpb.ControlService.CreateBlockchains:output_type -> rpcpb.CreateBlockchainsResponse
	15, // 59: rpcpb.ControlService.CreateSubnets:output_type -> rpcpb.CreateSubnetsResponse
	17, // 60: rpcpb.ControlService.Health:output_type -> rpcpb.HealthResponse
	19, // 61: rpcpb.ControlService.URIs:output_type -> rpcpb.URIsResponse
	21, // 62: rpcpb.ControlService.WaitForHealthy:output_type -> rpcpb.WaitForHealthyResponse
	23, // 63: rpcpb.ControlService.Status:output_type -> rpcpb.StatusResponse
	25, // 64: rpcpb.ControlService.StreamStatus:output_type -> rpcpb.StreamStatusResponse
	29, // 65: rpcpb.ControlService.RemoveNode:output_type -> rpcpb.RemoveNodeResponse
	31, // 66: rpcpb.ControlService.AddNode:output_type -> rpcpb.AddNodeResponse
	27, // 67: rpcpb.ControlService.RestartNode:output_type -> rpcpb.RestartNodeResponse
	33, // 68: rpcpb.ControlService.Stop:output_type -> rpcpb.StopResponse
	35, // 69: rpcpb.ControlService.AttachPeer:output_type -> rpcpb.AttachPeerResponse
	37, // 70: rpcpb.ControlService.SendOutboundMessage:output_type -> rpcpb.SendOutboundMessageResponse
	39, // 71: rpcpb.ControlService.SaveSnapshot:output_type -> rpcpb.SaveSnapshotResponse
	41, // 72: rpcpb.ControlService.LoadSnapshot:output_type -> rpcpb.LoadSnapshotResponse
	43, // 73: rpcpb.ControlService.RemoveSnapshot:output_type -> rpcpb.RemoveSnapshotResponse
	45, // 74: rpcpb.ControlService.GetSnapshotNames:output_type -> rpcpb.GetSnapshotNamesResponse
